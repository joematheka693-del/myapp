...
const Seventhcomponent = () => {
    ...
    // The useState() hook enables us to create dynamic website where by it usually has the start/ initial state followed by a state that gets shown when some effects happen on our website.
